  ...
  return (
    <div className="p-4 rounded-md flex flex-col bg-slate-950 sm:flex-wrap">
      <div className="flex flex-col sm:flex-row sm:items-center sm:flex-wrap gap-x-4">
        ...
        <p className="text-sm text-sla capitalize">{exercise.type}</p>
      </div>
      ...
      <div className="flex flex-colbg-slate-950 rounded gap-2">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 sm:place-items-center gap-2">
        ...
        <button
          ...
          className="flex flex-col p-2 rounded border-[1.5px] duration-200 border-blue-900 hover:border-blue-600 border-solid w-full"
        >
